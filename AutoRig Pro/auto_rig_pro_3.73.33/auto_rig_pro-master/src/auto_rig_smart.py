...
def register():
    ...
    bpy.types.Scene.arp_fingers_to_detect = IntProperty(description = "How many fingers should be found on this model", name = "Fingers Detection", default=5, min=0, max=5, options={'HIDDEN'})
    bpy.types.Scene.arp_fingers_enable = BoolProperty(description="Enable fingers", name = "Enable Fingers", default=True, options={'HIDDEN'})
    ...
    bpy.types.Scene.arp_smart_ears = BoolProperty(default=True, description='Enable ears', update=update_smart_ears)
    bpy.types.Scene.arp_smart_eyebrows = BoolProperty(default=True, description='Enable eyebrows', update=update_smart_eyebrows)
    bpy.types.Scene.arp_smart_nose = BoolProperty(default=True, description='Enable nose', update=update_smart_nose)
    bpy.types.Scene.arp_smart_cheeks = BoolProperty(default=True, description='Enable cheeks', update=update_smart_cheeks)
    bpy.types.Scene.arp_smart_eyes = BoolProperty(default=True, description='Enable eyes', update=update_smart_eyes)
    bpy.types.Scene.arp_smart_mouth = BoolProperty(default=True, description='Enable mouth', update=update_smart_mouth)
    bpy.types.Scene.arp_smart_tongue = BoolProperty(default=True, description='Enable tongue')
    bpy.types.Scene.arp_smart_teeth = BoolProperty(default=True, description='Enable teeth')
    bpy.types.Scene.arp_smart_chin = BoolProperty(default=True, description='Enable chin', update=update_smart_chin)
